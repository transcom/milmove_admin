...
prepare_key_standalone:
	./scripts/generate-key #todo: remove LOGIN_GOV_SECRET_KEY & LOGIN_GOV_KID_JWK from circle ci env variables once we land a better way to handle LOGIN_GOV_JWK_SET_FILENAME
